...
if($action == "save")
{
    ...
    $sql = "INSERT INTO yiqi_category (cid,name,type,pid,seotitle,seokeywords,seodescription,description,filename,templets,takenumber,status,thumb)".
    		" VALUES (null,'$categoryname','$categorytype','$parentcategory','$categoryseotitle','$categoryseokeywords','$categoryseodescription','$categorydescription','$categoryfilename','$categorytemplets','$categorytakenumber','ok','$categorythumb')";
...
<tr><td class="label">分类广告图片</td><td class="input">图片：<input class="upfile txt" type="file" style="width:280px;" name="image" />
	<br>链接：<input type="text" class="txt" name="thumburl" value="" />
	</td></tr>
</table>
<div class="clear">&nbsp;</div>
