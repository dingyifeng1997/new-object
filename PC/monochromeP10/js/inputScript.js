...
function getLine3() {
    ...
    $("#partsC3").text(accMul(zhuanjieban, 25));
}
...
function getLine8() {
    ...
    $("#partsH3").text(accMul(corner, number));  //接头合计
}
...
function getLine9() {
    var number = 0;
    if (moduleHeightNumber <= 5) {
        number = accMul((moduleWidthNumber + 1 + Math.floor(screenWidth / 300)), 6);
    } else {
        number = 24;
    }
