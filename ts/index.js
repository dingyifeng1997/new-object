...
//中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6,25,274,46,60,5000,360,random(1,3),"chidao.png","weizhidao.png"));
        }
//大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,210,110,164,30000,540,1,"chidao.png","weizhidao.png"));
            mark1=0;
        }
//小飞机
        else{
            enemys.push(new enemy(1,19,286,34,24,1000,360,random(1,4),"chidao.png","weizhidao.png"));
        }
        mark=0;
    }
...
//碰撞本方飞机，游戏结束，统计分数
                        selfplan.imagenode.src="feiji.png";
